  ...
  return (
    <div>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "2rem" }}>
        <h1 className="utrecht-heading-1" style={{ margin: 0 }}>Organisaties</h1>
        <a href="/organisaties/nieuw" className="utrecht-button utrecht-button--primary-action">+ Nieuwe organisatie</a>
      </div>
            ...
            {orgs.map((org) => (
              <tr key={org.id} className="utrecht-table__row">
                <td className="utrecht-table__cell">
                  <a href={`/organisaties/${org.id}`} className="utrecht-link" style={{ fontWeight: 600 }}>
                    {org.name}
                  </a>
                </td>
                <td className="utrecht-table__cell">
                ...
                <td className="utrecht-table__cell">
                  <a href={`/organisaties/${org.id}/bewerken`} className="utrecht-link" style={{ marginRight: "1rem" }}>Bewerken</a>
                </td>
              </tr>
            ))}
          </tbody>

...
export const metadata: Metadata = { title: "Nieuw budgetbedrag – Teambeheer" };
...
export default async function NieuwBedragPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (!source) notFound();
  if (source.types.length === 0) redirect(`/financiering/${id}/types/nieuw`);
